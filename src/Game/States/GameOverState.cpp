...
void GameOverState::render() {
	ofDrawBitmapString("Final Score: " + to_string(score), ofGetWidth()/2, ofGetHeight()/2-300, 50);
	ofDrawBitmapString("Game Over: Try again",ofGetWidth()/2,ofGetHeight()/2-150,50);
